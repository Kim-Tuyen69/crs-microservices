...
import vn.edu.crs.courseservice.repository.CourseRepository; import lombok.RequiredArgsConstructor;
...
public class CourseService {
    ...
    public CourseDTO create(CourseDTO dto) {
        if
        (courseRepository.existsByTenMonHocIgnoreCase(dto.getTenMonHoc())) {  throw new IllegalArgumentException("Ten mon hoc da ton tai");  }
    ...
    public CourseDTO update(Long id, CourseDTO dto) {
        ...
        course.setSoTinChi(dto.getSoTinChi());
        course.setSoChoToiDa(dto.getSoChoToiDa());
        // Khong cho sua truc tiep soChoConLai qua API update thong thuong  // (soChoConLai chi duoc thay doi qua reserve-seat/release-seat o  Buoi 3)
        return toDTO(courseRepository.save(course));
    }
